...
public class SalesPurchaseCogsGrossMarginRequestDTO extends AbstractEntityDTO {
    ...
    public SalesPurchaseCogsGrossMarginRequestDTO() {
    }

    public SalesPurchaseCogsGrossMarginRequestDTO(String loanId, String bookExist, String basisOfSales, String salesCalculation, String purchaseCalculation) {
        this.loanId = loanId;
