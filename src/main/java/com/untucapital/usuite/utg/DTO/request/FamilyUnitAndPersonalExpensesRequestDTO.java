...
public class FamilyUnitAndPersonalExpensesRequestDTO extends AbstractEntity {
    ...
    public FamilyUnitAndPersonalExpensesRequestDTO() {
    }

    public FamilyUnitAndPersonalExpensesRequestDTO(String loanId, String maritalStatus, String nameOfSpouse, String guarantor, String numberOfChildren, String otherDependents) {
        this.loanId = loanId;
