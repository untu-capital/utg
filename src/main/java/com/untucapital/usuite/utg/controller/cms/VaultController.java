...
//    }
    ...
    public ResponseEntity<Vault> getVaultsByBranchAndType(@PathVariable String branch, @PathVariable String type) {
        Vault vaults = vaultService.getVaultsByBranchAndType(branch, type);
