...
public class ClientLoanController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<ClientLoan> getClientLoanApplicationById(@PathVariable("id") long clientloanID) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<ClientLoan> updateClient(@PathVariable("id") long id, @RequestBody ClientLoan clientLoan) {
    ...
    //http://localhost:8080/api/loan_appliation/1
    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteClientLoan(@PathVariable("id") long id) {
